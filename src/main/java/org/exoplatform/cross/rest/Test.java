...
public class Test {
	...
	public static void main(String[] args) throws ParseException {
		...
		// System.out.println(diffDate("11-02-1982", "11-03-1982", "MIN"));
		// System.out.println(diffDate("11-02-1982", "11-03-1982", "hour"));
		// System.out.println(diffDate("11-02-1982", "11-03-1982", "null"));
		// System.out.println( plusOperator("7","9"));

		System.out.println(divOperator("1", "2"));
	}

	@GET
	@Path("/plus/{x}/{y}")
	public static String divOperator(@PathParam("x") String x,
		...
		try {
			...
			return "Type of x and y must be Integer";
		}
		return String.valueOf(x_convert / y_convert);
		// return String.valueOf(Float.valueOf( x_convert / y_convert));
	}

	@GET
	@Path("/diff/{date1}/{date2}/{resultType}")
	public static String diffDate(@PathParam("date1") String date1,
			@PathParam("date2") String date2,
			@PathParam("resultType") String resultType) {
		String errorMsg = "url is not in correct format. Good url ex :  /diffDate/11-05-2011/11-07-2012/M  ";
